...
bert_model.eval()
bert_model.load_state_dict(torch.load('src/models/saved_models/bert_fine_tuned_weighted.pt'))
...
# save results as csv
performance_df.to_csv('results/finetune_bert_weighted_performance_metrics.csv')
print(f'Overall accuracy for fine-tuned (class weighted) BERT is: {accuracy}')